                     ...
                     <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                           <a class="nav-link" href="{{ route('product.index') }}"
                              style="color:@php echo Request::path()==" products"?"#f7444e":"black"
                              @endphp">Products</a>
                        </li>
                        {{-- <li class="nav-item">
                        ...
                        <li class="nav-item">
                           <a class="me-4 nav-link position-relative" href="{{ route('cart') }}"
                              style="color:@php echo Request::path()==" cart"?"#f7444e":"black" @endphp">
                        ...
                        <li class="nav-item"><a href="{{ route('login') }}" class="nav-link"
                              style="color:@php echo Request::path()==" login"?"#f7444e":"black" @endphp">LOGIN</a></li>
                        @endif
