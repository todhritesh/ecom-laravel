               ...
               <div class="col-lg-8">
                  <div class="card">
                      <div class="card-body box d-flex mt-1">
                          ...
                          <div class="vr"></div>
                          <div class="ms-4">
                              <p class="fw-bold fs-5 mb-1">Ahuja Speakers</p>
                              <p class="fs-6 mb-3">₹1270</p>
                              <div class="d-flex">
                                  <a href="" class="btn btn-outline-dark fs-5 py-0 mt-2" style="height: 30px">-</a>
                                  <p class="lead mt-2 fs-5 px-2">1</p>
                                  <a href="" class="btn btn-outline-dark fs-5 py-0 mt-2" style="height: 30px">+</a>
                              </div>
                          ...
                          <div class="ms-auto">
                              <div class="btn-box">
                                  <div class="options">
                                      <a href="{{ route('checkout'  ) }}" class="option1">BUY NOW</a>
